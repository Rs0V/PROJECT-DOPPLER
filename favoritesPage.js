window.onload = () => {
    ...
    let songs = window.localStorage.getItem(`${user}-favs`)
    ...
    if (songs == null || songs == "none" || songs.length == 0) {
        ...
        oops.innerHTML = "Looks like you haven't saved any songs to your favorites yet"
        ...
        for (let index = 0; index < songs.length - 1; index += 2) {
            ...
            trash.addEventListener("click", event => {
                ...
                window.localStorage.setItem(`${user}-favs`, newSongsList)
                song.remove()
                trash.remove()
